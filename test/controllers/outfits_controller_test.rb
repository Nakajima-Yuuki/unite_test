...
class OutfitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create outfit" do
    assert_difference('Outfit.count') do
      post outfits_url, params: { outfit: { content: @outfit.content, title: @outfit.title } }
    end
  ...
  test "should update outfit" do
    patch outfit_url(@outfit), params: { outfit: { content: @outfit.content, title: @outfit.title } }
